      ...
      <motion.div
        ...
        >
          <div className="relative after:content-[''] after:animate-pulse transition-all after:absolute after:w-[400px] after:h-[400px] after:rounded-full after:top-[-13px] after:left-[-301px] after:bg-[#5dbcfc5f] flex items-start flex-col">
            ...
            <div className="md:text-[45px] text-[25px] font-bold relative after:animate-pulse after:absolute text-white after:w-[250px] after:h-[250px] after:bg-[#5dbcfc30] after:content-[''] after:bottom-[150px] after:rounded-full after:right-[-36px]">
              I'm Ahmed El Rooby
